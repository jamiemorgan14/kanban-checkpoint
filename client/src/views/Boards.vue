<template>
  <div class="boards row">
    <div class="col-12 text-light">
      <i @click="goBack" class="far fa-caret-square-left d-flex justify-content-start mt-2"></i>
      <h1 class="text-center">All of your Boards, all in one place</h1>
    </div>
    <div class="col-12 text-center">
      <form @submit.prevent="addBoard">
        <input autofocus type="text" placeholder="title" v-model="newBoard.title" required>
        <input type="text" placeholder="description" v-model="newBoard.description" class="ml-1">
        <br>
